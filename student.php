					...
					<div class="modal-content">
						...
						<form id='student-frm'>
							<div class ="modal-body">
								...
								<div class="form-group">
									<label>Branch</label>
									<input type="text" name ="level_section" ="" class="form-control" />
								</div>
								<div class="form-group">
        					...
        					<button type="submit" name="submit">Upload</button>
								<button  class="btn btn-primary" name="save">	<phpoffice>
	<phpspreadsheet><input type="file" name="excel_file" accept=".xlsx, .xls"></phpspreadsheet><span class="glyphicon glyphicon-save"></span> Save</button>
							</div>
						</form>
					</div>
				</div>
